...
class TweetCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        infoLabel.text = "Zak Test @zaktest"
        
        let actionStack = UIStackView(arrangedSubviews: [commentButton, likeButton, repostButton, shareButton])
    ...
    @objc func handleProfileImageTapped() {
        print("DEBUG: Gesture is working on tap!")
    ...
    func configure() {
        ...
        let viewModel = TweetViewModel(post: post)
